...
public class SoapPortImpl implements HeaderTester {
    ...
    public void outHeader(OutHeader me, javax.xml.ws.Holder<OutHeaderResponse> theResponse, javax.xml.ws.Holder<SOAPHeaderData> headerInfo) {
        ...
        try {
            ...
            theResponseValue.setResponseType("ResponseType-2056283762");
            ...
            headerInfoValue.setOriginator("Originator-615180588");
            headerInfoValue.setMessage("Message194890139");
    ...
    public org.apache.headers.InHeaderResponse inHeader(InHeader me, SOAPHeaderData headerInfo) {
        ...
        System.out.println("Request Type "+me.getRequestType());
        System.out.println("message Header "+headerInfo.getMessage());
        try {
            org.apache.headers.InHeaderResponse _return = new org.apache.headers.InHeaderResponse();
            _return.setResponseType("ResponseType-382363285");
    ...
    public org.apache.headers.InoutHeaderResponse inoutHeader(InoutHeader me, javax.xml.ws.Holder<SOAPHeaderData> headerInfo) {
        ...
        System.out.println("inoutHeader "+me.getRequestType());
        System.out.println("inoutHeader value "+headerInfo.value);
        System.out.println("inoutHeader "+headerInfo.value.getMessage());
        try {
            org.apache.headers.InoutHeaderResponse _return = new org.apache.headers.InoutHeaderResponse();
            _return.setResponseType("InoutHeaderResponse");            
            return _return;
        } catch (java.lang.Exception ex) {
            ex.printStackTrace();
            throw new RuntimeException(ex);
