...
public class ObjectFactory {
    ...
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://server.com/", "addEmployeeResponse");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://server.com/", "getEmployeeResponse");
    private final static QName _GetEmployeesResponse_QNAME = new QName("http://server.com/", "getEmployeesResponse");
    private final static QName _GetEmployees_QNAME = new QName("http://server.com/", "getEmployees");
    private final static QName _AddEmployee_QNAME = new QName("http://server.com/", "addEmployee");
    private final static QName _GetEmployee_QNAME = new QName("http://server.com/", "getEmployee");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "addEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "getEmployeesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "getEmployees")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.com/", name = "addEmployee")
