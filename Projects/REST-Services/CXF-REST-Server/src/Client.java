...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        URL url = new URL("http://localhost:9090/customerservice/customers/123");
        ...
        url = new URL("http://localhost:9090/customerservice/orders/223/products/323");
        in = url.openStream();
        System.out.println(getStringFromInputStream(in));
        ...
        PutMethod put = new PutMethod("http://localhost:9090/customerservice/customers");
        ...
        DeleteMethod del = new DeleteMethod("http://localhost:9090/customerservice/customers/123");
        
        httpclient = new HttpClient();

        try {
            int result = httpclient.executeMethod(del);
            System.out.println("Response status code after delete : " + result);
            System.out.println("Response body: ");
