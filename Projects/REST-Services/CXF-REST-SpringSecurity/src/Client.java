...
public final class Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // 1. get customer info  
        // 
        c.getCustomerInfo("mohan", "SWaDesh", 123);
        c.getCustomerInfo("sukhia", "gaon", 123);
        c.getCustomerInfo("bob", "wed", 123);

        // 2. add customer info  
        // 
        c.addCustomerInfo("mohan", "SWaDesh");
        c.addCustomerInfo("sukhia", "gaon");
         
        // 3. update customer info  
        // 
        c.updateCustomerInfo("mohan", "SWaDesh");
        c.updateCustomerInfo("sukhia", "gaon");

        // 4. delete customer info  
        // 
        c.deleteCustomerInfo("mohan", "SWaDesh", 123);
        c.deleteCustomerInfo("sukhia", "gaon", 123);
    ...
    public void getCustomerInfo(String name, String password, int id) throws Exception {
        ...
        GetMethod get = 
            new GetMethod("http://localhost:8090/CXF-REST-SpringSecurity/customerservice/customers/" + id);
    ...
    public void addCustomerInfo(String name, String password) throws Exception {
        ...
        System.out.println("HTTP POST to add customer info, user : " 
            + name + ", password : " + password);
        PostMethod post = new PostMethod("http://localhost:8090/CXF-REST-SpringSecurity/customerservice/customers/");
    ...
    public void updateCustomerInfo(String name, String password) throws Exception {
        ...
        System.out.println("HTTP PUT to update customer info, user : " 
            + name + ", password : " + password);
        PutMethod put = new PutMethod("http://localhost:8090/CXF-REST-SpringSecurity/customerservice/customers/123");
    ...
    public void deleteCustomerInfo(String name, String password, int id) throws Exception {
        ...
        DeleteMethod del = 
            new DeleteMethod("http://localhost:8090/CXF-REST-SpringSecurity/customerservice/customers/" + id);
